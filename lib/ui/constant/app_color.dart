...
class AppColor {
  // static const primarycolor = Color(0xff2DBB54);
  // static const primary = Color(0xff2DBB54);

  static const primarycolor = Color(0xFF2F3C7E);
  static const primary =Color(0xFF2F3C7E);
  static const apbarclr =Color(0xFF98A6EE);
static const settingclr = Color(0xFFE3E7FD);
  static const secondary = Color(0xFFe96561);
  static const  bgLight = Color(0xFFF0F2F9);
...
static const  white = Color(0xFFFFFFFF);
  ...
  static const backgroundColor = Color(0xfff2f9fe);
