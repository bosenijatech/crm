...
class Estimatehomescreen extends StatefulWidget {
  ...
  @override
  State<Estimatehomescreen> createState() => _EstimatehomescreenState();
}

class _EstimatehomescreenState extends State<Estimatehomescreen> {
        ...
        children: [
          SpeedDialChild(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Createestimatescreen()),
              );
            },
          ),
          SpeedDialChild(
            ...
            label: 'Create Fixed Estimate',
            backgroundColor: AppColor.primary,
            onTap: () =>     Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Createfixedestimatescreen()),
              ),
          ),
          SpeedDialChild(
            child: SvgPicture.asset(
              AppAssets.anotherestimate,
              width: 20,
              height: 20,
              color: AppColor.white,
            ),
            label: 'From Another Estimate',
            backgroundColor: AppColor.primary,
